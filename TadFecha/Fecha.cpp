...
Fecha::Fecha( )
{
    // Asigno a la variable ahora el tiempo 0 que me pasa la funcion time()
    time_t ahora = time(0);
    //Asigno al puntero fechaDeSistema el valor de ahora del Struct
    tm *fechaDeSistema = localtime(&ahora);
...
int Fecha::diaSemana()
{
    ...
    // Algoritmo de Zeller, que determina el dia usando la siguiente formula
    a = (14-mes)/12;
    y=anio-a;
    m = mes +12*a-2;
